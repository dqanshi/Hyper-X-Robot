...
def send_start(bot, update):
    ...
    update.effective_message.reply_photo(HELP_PANEL_STRING.HYPER_X_IMG,text.format(escape_markdown(first_name), escape_markdown(bot.first_name)), reply_markup=InlineKeyboardMarkup(keyboard), parse_mode=ParseMode.MARKDOWN)
